...
const PlaylistsModal = () => {
  ...
  let playLists = [{ name:'Rock ', owner : 'Naoual MEDJOUB' , image: urlImage},
  ...
  return (
    <div className="Global bg-grey w-full h-full flex flex-col  "  style={{ width:'100%', height:'100%'}}>
      < div className= {styles.AjoutPlaylist} onClick={(_: any) => console.log("NOT IMPLEMENTED")} >
        <h2 className="text-gry" > <FontAwesomeIcon className="IconePlus" icon={faPlus} style={{ marginRight: '10px', color: 'black', background : 'white'}} /> Ajouter une playList </h2>
      </div>
