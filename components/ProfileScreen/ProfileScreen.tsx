          ...
          <div className="grid grid-cols-3 grid-rows-2 gap-4">
            <div className="row-span-2 text-center">
              ...
              <img
                ...
                className={`md:mx-auto object-contain h-${imageProps.size || 60} w-${
                  imageProps.size || 60
                } rounded-lg`}
                alt="image to upload"
              /> )}
            ...
            <div className="col-start-2 col-end-3">
              <button  onClick={handleShowForm} className="font-medium text-wht rounded-full border-2 border-grn px-2 text-md h-7 hover:bg-grn hover:bg-opacity-25">
                <span>Password</span>
                <FontAwesomeIcon
